(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),exports, require('@angular/common'), require('@angular/core'), require('imagesloaded'), require('masonry-layout')) :
    typeof define === 'function' && define.amd ? define('ngx-masonry-gallery', ['@angular/core','@angular/common','exports', '@angular/common', '@angular/core', 'imagesloaded', 'masonry-layout'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global['ngx-masonry-gallery'] = {}, global.ng.common, global.ng.core, global.imagesLoadedMethod, global.masonry));
}(this, function (ɵngcc0,ɵngcc1,exports, common, core, imagesLoadedMethod, masonry) { 'use strict';

    imagesLoadedMethod = imagesLoadedMethod && imagesLoadedMethod.hasOwnProperty('default') ? imagesLoadedMethod['default'] : imagesLoadedMethod;
    ...
    var MasonryGalleryComponent = /** @class */ (function () {
        ...
        MasonryGalleryComponent.propDecorators = {
            ...
            verticalGutter: [{ type: core.Input }],
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(MasonryGalleryModule, { declarations: [MasonryGalleryComponent], imports: [ɵngcc1.CommonModule], exports: [MasonryGalleryComponent] }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(MasonryGalleryModule, [{
    ...
    exports.IMasonryGalleryImage = IMasonryGalleryImage;
...
//# sourceMappingURL=ngx-masonry-gallery.umd.js.map
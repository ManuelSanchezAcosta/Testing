(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/core'), require('echarts'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('ngx-echarts', ['@angular/core','exports', '@angular/core', 'echarts', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory(global.ng.core,global['ngx-echarts'] = {}, global.ng.core, global.echarts, global.rxjs, global.rxjs.operators));
}(this, function (ɵngcc0,exports, core, echarts, rxjs, operators) { 'use strict';

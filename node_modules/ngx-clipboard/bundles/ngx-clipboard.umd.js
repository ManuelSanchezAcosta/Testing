(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),exports, require('ngx-window-token'), require('rxjs'), require('@angular/common'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('ngx-clipboard', ['@angular/core','@angular/common','exports', 'ngx-window-token', 'rxjs', '@angular/common', '@angular/core'], factory) :
    (factory(global.ng.core,global.ng.common,(global['ngx-clipboard'] = {}),global.i2,global.rxjs,global.ng.common,global.ng.core));
}(this, (function (ɵngcc0,ɵngcc1,exports,i2,rxjs,i1,i0) { 'use strict';
...
ClipboardService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ClipboardService, factory: function (t) { return ClipboardService.ɵfac(t); }, providedIn: 'root' });

...
export declare class GistDirective {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<GistDirective, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<GistDirective, "[gist]", never, { "gist": "gist"; }, { "gistLoad": "gistLoad"; }, never>;
}
export declare class GistFilePipe implements PipeTransform {
    transform(gist: Gist, fileName: string): string | null;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<GistFilePipe, never>;
    static ɵpipe: ɵngcc0.ɵɵPipeDefWithMeta<GistFilePipe, "gistFile">;
}
